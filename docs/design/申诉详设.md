...
|----|----|
|API名称|1.2 增加申诉项|
|API签名|`/api/appeal/item/add`|
|请求参数|`{"appealId":"","type":"","content":""}`|
|响应结果|`{"itemId":"","result":"success/fail"}`|
|关键步骤|- 1.2.1 增加申诉项|
|状态和异常|400、404、500|
...
|----|----|
|API名称|1.3 下载模板|
|API签名|`/api/appeal/template/download`|
|请求参数|`{"templateType":""}`|
|响应结果|模板文件流|
|关键步骤|- 1.3.1 文件下载模板|
|状态和异常|404、500|
...
|----|----|
|API名称|1.4 导入申诉明细|
|API签名|`/api/appeal/item/import`|
|请求参数|`{"appealId":"","file":文件}`|
...
|----|----|
|API名称|3.1 申诉审核查询|
|API签名|`/api/appeal/audit/query`|
|请求参数|`{"status":"待审核/全部","page":1,"size":20}`|
|响应结果|`{"appeals":[{"appealId":"","orderId":"","type":"","status":""}],"total":100}`|
|关键步骤|- 3.1.1 查询待审核申诉单|
|状态和异常|400、500|
...
|----|----|
|API名称|3.4 审核通知|
|API签名|`policy_appeal_event_topic`（MQ Topic）|
|请求参数|`{"appealId":"","auditResult":""}`|
|响应结果|`{"result":"success/fail"}`|
|关键步骤|- 3.4.1 通知收单|
|状态和异常|500|
